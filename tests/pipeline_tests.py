...
from bardi.nlp_engineering import (
...
class TestPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_path = f"{test_data_dir}/" f"pipeline_test_df.pkl"
        ...
        self.dataset = data.from_pandas(self.data_df)
    ...
    def test_adding_steps(self):
        ...
        correct_ans = 3
        self.assertEqual(
            self.pipeline.num_steps,
            correct_ans,
            ("Pipeline's num_steps attribute returns " "an incorrect value"),
        )
